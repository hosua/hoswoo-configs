...
/* hoswoo's modifications[] */
static const char *startalsa[] = { "st", "alsamixer", NULL };
static const char *startdiscord[] = { "discord", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,	-1,		XK_v,	spawn,		{.v = startalsa } },
	{ MODKEY|Mod1Mask,	-1,		XK_d,	spawn,		{.v = startdiscord } },
	{ MODKEY|Mod1Mask,	-1,		XK_Print,	spawn,	{.v = screenshot } },
	...
	/* Removed because I don't use emacs */
